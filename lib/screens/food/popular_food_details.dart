...
import 'package:food_deliveryapp/widgets/app_icons.dart';
        ...
        child: Row(
          ...
          children: [
            Container(
              ...
              child: Row(
                children: [
                  Icon(Icons.remove, color: Colors.brown,),
                  SizedBox(width: Dimensions.width10/2,),
                  BigText(text: "0", color: Colors.brown,),
                  SizedBox(width: Dimensions.width10/2,),
